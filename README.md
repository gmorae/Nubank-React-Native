...
[Expo Docs (Android/iOS)](https://docs.expo.io/)
  
## :information_source: How To Use

To clone and run this application, you'll need [Git](https://git-scm.com), [Node.js v10.16][nodejs] or higher + [Expo ][expo] or higher installed on your computer. From your command line:

```bash
# Clone this repository
$ git clone https://github.com/gmorae/Nubank-React-Native nubank
...
Made with ♥ by Gabriel Moraes :wave: [Get in touch!](https://www.linkedin.com/in/gmorae/)
